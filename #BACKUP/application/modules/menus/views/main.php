            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-md-6 pull-right text-right">
                        <a href="<?php echo base_url(); ?>menus-tambah" class="btn btn-primary btn-sm"><i class="fa fa-plus-square"></i> Tambah</a> 
                        <a href="<?php echo base_url('menus-pdf/?template=table_pdf&name=account'); ?>" target="__blank" class="btn btn-default btn-sm"><i class="fa fa-print"></i> Print</a>
                        <a href="<?php echo base_url('menus-excel/?template=table_excel&name=account'); ?>" target="__blank" class="btn btn-default btn-sm"><i class="fa fa-file-excel-o"></i> Excel</a>
                    </div> 
                </div>
            </div>
                                ...
                                foreach ($data as $k => $v) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-warning" href="<?php echo base_url("menus-edit-" . $v['id']); ?>">Edit</a> 
                                            <a class="btn btn-sm btn-danger" href="<?php echo base_url("menus-delete-" . $v['id']); ?>" onclick="return confirm('Yakin Hapus Data ?');">Delete</a> 
                                        </td>
                                    </tr>
    <?php }
} ?>
                        ...
                        <tfoot>
                        <form id="form1" method="post" action="<?php echo base_url('menus'); ?>">
                            <tr>
                                <td>#</td>
                                <td>
                                    <input class="form-control input-sm" name="nama_lengkap" class="form-control" value="<?php echo (isset($sr_data['nama_lengkap']) ? $sr_data['nama_lengkap'] : ""); ?>" type="text" onkeyup="javascript:if (event.keyCode == 13) {
                                                                                    submit_search('form1');
                                                                                } else {
                                                                                    return false;
                                                                                }
                                ...
                                <td>
                                    <input class="form-control input-sm" name="no_telp" value="<?php echo (isset($sr_data['no_telp']) ? $sr_data['no_telp'] : ""); ?>" style="width: 100%;" type="text" onkeyup="javascript:if (event.keyCode == 13) {
                                                                                    submit_search('form1');
                                                                                } else {
                                                                                    return false;
                                                                                }
