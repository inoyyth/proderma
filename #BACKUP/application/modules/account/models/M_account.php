...
Class M_account extends CI_Model {
    ...
    public function save() {
        ...
        if (empty($id)) {
            $cekExistEmail = $this->__cekExistEmail($this->input->post('username'));
            log_message('DEBUG', count($cekExistEmail));
            if ($cekExistEmail['total'] > 0) {
                return false;
                die;
            }
        }
        ...
        $data = array('username' => $this->input->post('username'),
            ...
            'super_admin' => $this->input->post('superadmin'),
            'id_branch' => $branch
        );
        if (empty($id)) {
    ...
    private function __cekExistEmail($username) {
