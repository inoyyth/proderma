                        ...
                        <div class="form-group">
                            ...
                            <select name="id_branch" parsley-trigger="change" required placeholder="Branch" class="form-control">
                                <?php foreach ($branch as $kBranch=>$vBranch) {?>
                                    <option value="<?php echo $vBranch['id'];?>" <?php echo ($vBranch['id'] == $data['id_branch'] ? "selected" : "");?>><?php echo $vBranch['branch_name'];?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="month_target" placeholder="Month Target" required class="form-control">
                                ...
                                ?>
                                <option value="<?php echo $kBln;?>" <?php echo ($kBln == $data['month_target'] ? "selected" : "");?>><?php echo $vBln;?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="year_target" placeholder="Year Target" required class="form-control">
                                ...
                                ?>
                                <option value="<?php echo $i;?>" <?php echo ($i == $data['year_target'] ? "selected" : "");?>><?php echo $i;?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Value</label>
                            <input name="value_target" parsley-trigger="change" value="<?php echo formatrp($data['value_target']);?>" required placeholder="Target Value" class="form-control number">
                        </div>
                    </div>
                </div>
