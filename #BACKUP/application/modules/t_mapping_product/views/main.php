<div class="row">
    ...
    <div class="col-lg-12" style="padding-bottom: 2px;">
		...
		<a href="<?php echo base_url('t_mapping_product/print_excel');?>" type="button" id="btn-excel" class="btn btn-xs btn-default"><i class="fa fa-edit"></i> Excel</a>
    </div>
    <div class="col-lg-12">
    ...
    $(document).ready(function () {
        ...
        $("#example-table").tabulator({
            ...
            rowDblClick:function(e, row){
                location.replace('<?php echo site_url(); ?>mapping-product-edit-' + row + '.html');
            },
        });
    });
