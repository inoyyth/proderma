...
<![endif]-->
<script src="<?php echo base_url();?>themes/assets/js/jquery-ui.custom.min.js"></script>
<script src="<?php echo base_url();?>themes/assets/js/jquery.ui.touch-punch.min.js"></script>
<script src="<?php echo base_url();?>themes/assets/js/jquery.easypiechart.min.js"></script>
<script src="<?php echo base_url();?>themes/assets/js/jquery.sparkline.index.min.js"></script>
<script src="<?php echo base_url();?>themes/assets/js/jquery.flot.min.js"></script>
<script src="<?php echo base_url();?>themes/assets/js/jquery.flot.pie.min.js"></script>
<script src="<?php echo base_url();?>themes/assets/js/jquery.flot.resize.min.js"></script>
