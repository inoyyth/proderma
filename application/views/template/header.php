...
<html lang="en">
    <head>
        ...
        <!-- ace styles -->
        <!-- ace styles -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>themes/assets/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>themes/assets/css/bootstrap-datepicker3.min.css" />
        <link rel="stylesheet" href="<?php echo base_url(); ?>themes/assets/css/bootstrap-timepicker.min.css" />        
        <link rel="stylesheet" href="<?php echo base_url(); ?>themes/assets/css/daterangepicker.min.css"/>
                    ...
                    <ul class="nav ace-nav">
                        ...
                        <li class="light-blue dropdown-modal">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                <img class="nav-user-photo" src="<?php echo base_url($this->sessionGlobal['path_foto']);?>" alt="Jason's Photo" />
                                <span class="user-info">
                                    <small>Welcome,</small>
                                    <?php echo $this->sessionGlobal['nama_lengkap'];?>
                                </span>
