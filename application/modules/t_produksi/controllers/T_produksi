...
class T_produksi extends MX_Controller {

    var $table = "t_produksi";

    public function __construct() {
        parent::__construct();
        $this->load->model(array('M_t_produksi' => 'm_t_produksi', 'Datatable_model' => 'data_table'));
        $this->load->library(array('Auth_log'));
        //set breadcrumb
        $this->breadcrumbs->push('Form Produksi', '/form-produksi');
    }
    ...
    public function add() {
        $this->breadcrumbs->push('Add', '/form-produksi-add');
        $data['view'] = "t_produksi/add";
        $this->load->view('default', $data);
    }
