                ...
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li><button class="btn btn-primary btn-sm pull-left" type="submit">Submit</button>
                            <a href="<?php echo base_url('product_brand'); ?>" class="btn btn-default pull-right">Cancel</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $code;?>" readonly="true" name="product_brand_code" parsley-trigger="change" required placeholder="Fill Brand Code" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Brand Name</label>
                                <input type="text" name="product_brand_name" parsley-trigger="change" required placeholder="Fill Brand Name" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Description</label>
                                <textarea name="product_brand_description" placeholder="Fill Brand Description" class="form-control mytextarea"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Status</label>
