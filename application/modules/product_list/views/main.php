    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li><a href="<?php echo base_url('product-list-tambah');?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-square"></i> Add</a></li>
                <li><a target="_blank" href="<?php echo base_url('product-list-pdf/?template=table_pdf&name=product_list');?>" class="btn btn-default btn-sm"><i class="fa fa-print"></i> Print</a></li>
                <li><a href="<?php echo base_url('product-list-excel/?template=table_excel&name=product_list');?>" class="btn btn-success btn-sm"><i class="fa fa-file-excel-o"></i> Excel</a></li>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                                ...
                                foreach ($data as $k => $v) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url('product-list-edit-' . $v['id']); ?>" class="btn btn-sm btn-warning"><i class="fa fa-trash-o"></i> Edit</a>
                                            <a href="<?php echo base_url('product-list-delete-' . $v['id']); ?>" onclick="return confirm('Sure to Delete ?');" class="btn btn-sm btn-danger"><i class="fa fa-edit"></i> Delete</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
                        ...
                        <tfoot>
                        <form id="form1" method="post" action="<?php echo base_url('product-list'); ?>">
                            <tr>
                                <td>#</td>
                                <td>
