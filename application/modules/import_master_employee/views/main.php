            ...
            <div class="widget-body">
                <form method="post" name="frmGroupUser" id="frmGroupUser" enctype="multipart/form-data">
                    ...
                    <div class="form-group" style="margin-left: 10px;">
                        ...
                        <a href="<?php echo site_url('import-employee-template'); ?>" class="btn btn-success btn-sm">[Download Template]</a>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#frmGroupUser").on("submit", function (event) {
            ...
            $.ajax({
                url: "<?php echo base_url('import-employee-upload'); ?>",
                type: "post",
                data: formData,
                cache: false,
                contentType: false,
                ...
                success: function (e) {
                    $btn.button('reset');
                    $('#id-input-file-3').ace_file_input('reset_input');
                    $("#example-table").tabulator("setData", "<?php echo base_url('import_master_employee/getListTable'); ?>");
                    //table.ajax.reload();
                },
                error: function (e) {
                    $('#id-input-file-3').ace_file_input('reset_input');
        ...
        $("#example-table").tabulator({
            ...
            ajaxURL: "<?php echo base_url('import_master_employee/getListTable'); ?>", //ajax URL
            ...
            columns: [//Define Table Columns
                ...
                {title: "Email", field: "employee_email", sorter: "string", tooltip: true},
                {title: "Gender", field: "gender", sorter: "string", tooltip: true},
        ...
        $("#delete-list").click(function(){
            ...
            $.ajax({
                url: "<?php echo base_url('import_master_employee/deleteListTable');?>",
                type: "post",
                data: {"data":json},
                cache: false,
                ////contentType: false,
        ...
        $("#save-list").click(function(){
            ...
            var json = JSON.stringify(selectedData); 
            $.ajax({
                url: "<?php echo base_url('import_master_employee/saveListTable');?>",
                type: "post",
                data: {"data":json},
                cache: false,
                ////contentType: false,
