<div class="row">
    <form action="<?php echo base_url("menus-save"); ?>" method="post"  enctype="multipart/form-data" parsley-validate novalidate>
        <div class="col-md-6">
            <div class="block-web">
                <div class="header">
                ...
                <div class="porlets-content">
                    ...
                    <a href="<?php echo base_url('menus'); ?>" class="btn btn-default">Cancel</a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
