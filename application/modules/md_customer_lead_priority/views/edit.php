...
<div class="row">
    <form action="<?php echo base_url("lead-customer-priority-save"); ?>" method="post"  enctype="multipart/form-data" parsley-validate novalidate>
        <div class="col-md-10">
            <div class="block-web">
                <div class="porlets-content">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label>Code</label>
                                        <input type="text" name="customer_code" value="<?php echo $data['customer_code'];?>" parsley-trigger="change" required placeholder="Code" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Name</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_source_lead_customer" parsley-trigger="change" required placeholder="Source Lead" class="form-control">
                                            ...
                                            <?php foreach ($source_lead_customer as $vSource) { ?>
                                                <option value="<?php echo $vSource['id']; ?>" <?php echo ($data['id_source_lead_customer']==$vSource['id']?"selected":"");?>><?php echo $vSource['source_lead_customer']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>Status Lead</label>
                                        <select name="id_status_lead_customer" parsley-trigger="change" required placeholder="Status Lead" class="form-control">
                                            <option value=""></option>
                                            <?php foreach ($status_lead_customer as $vStatus) { ?>
                                                <option value="<?php echo $vStatus['id']; ?>" <?php echo ($data['id_status_lead_customer']==$vStatus['id']?"selected":"");?>><?php echo $vStatus['status_lead_customer']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                    ...
                    <a href="<?php echo site_url('lead-customer-priority'); ?>" class="btn btn-default">Cancel</a>
                </div>
            </div>
        </div>
    </form>
