                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $code;?>" readonly="true" name="product_category_code" parsley-trigger="change" required placeholder="Fill Category Code" class="form-control">
                            </div>
                            <div class="form-group">
