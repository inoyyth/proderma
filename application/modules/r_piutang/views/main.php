...
<script>
    ...
    function subReport(tp) {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url('r_piutang/getReport');?>',
            data: dt,
        ...
        .done(function (data){
            ...
            $("#example-table").tabulator({
                ...
                ajaxURL: "<?php echo base_url('r_piutang/getListTable'); ?>", //ajax URL
                ajaxParams: tabulatorAjaxParams,
                groupBy:"kelompok",
                columns: [//Define Table Columns
                    {formatter: "rownum", align: "center", width: 40},
                    {title: "Invoice Code", field: "invoice_code", tooltip: true},
                    {title: "Duedate Create", field: "create_date", tooltip: true},
                    {title: "Status", field: "pay_duedate_status"},
                    {title: "Duedate", field: "pay_date"}
                ],
                selectable: 1,
            });
        });
