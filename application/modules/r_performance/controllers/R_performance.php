...
class R_performance extends MX_Controller {
    ...
    public function __construct() {
        ...
        //set breadcrumb
        $this->breadcrumbs->push('Report Performance Sales', '/employee-level');
    }

    public function index() {
        $data['template_title'] = array('Report Performance Sales', 'List');
    ...
    public function getReport() {
        ...
        if ($month == NULL || $month == "") {
            ...
            $dt = $this->m_performance->getYearlyReport($year)->result_array();
            $dt_bulan = array();
            foreach ($dt as $k => $v) {
            ...
            $dt = $this->m_performance->getDailyReport($month, $year)->result_array();
            $dt_tgl = array();
            foreach ($dt as $k => $v) {
                $dt_tgl[] = $v['tgl'];
            }
    ...
    public function getListTable() {
        ...
        $list = $this->m_performance->getListTable($field, $table, $join, $like, $where, $sort, $limit_row);
