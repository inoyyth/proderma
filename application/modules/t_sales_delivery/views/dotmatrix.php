...
<body>
    ...
    <div style="margin-top: 10px;">
        <div style="float:left;width:48%;">
            <table style="width: 100%;" style="font-size:11px;" >
                ...
                <tr>
                    <td style="font-size:11px;border-left:1px solid;border-right:1px solid;border-bottom:1px solid;"><?php echo $customer['customer_name']; ?></td>
                </tr>
                <tr>
                    <td style="font-size:11px;border-left:1px solid;border-right:1px solid;border-bottom:1px solid;"><?php echo $customer['customer_address']; ?></td>
                </tr>
                <tr>
                    <td style="font-size:11px;border-left:1px solid;border-right:1px solid;border-bottom:1px solid;">HP: <?php echo $customer['customer_phone']; ?></td>
                </tr>
            </table>
        </div>
        <div style="float:right;width:48%;">
            <table style="width: 100%;" style="font-size:11px;" >
                ...
                <tr>
                    ...
                    <td style="font-size:11px;border-right:1px solid;border-bottom:1px solid;">: <?php echo tanggalan($data['so_date']); ?></td>
                </tr>
                <tr>
                    <td style="font-size:11px;border-left:1px solid;border-right:1px solid;border-bottom:1px solid;">Tgl.Surat Jalan</td>
                    <td style="font-size:11px;border-right:1px solid;border-bottom:1px solid;">: <?php echo tanggalan($data['do_date']); ?></td>
                </tr> 
                <tr>
                    <td style="font-size:11px;border-left:1px solid;border-right:1px solid;border-bottom:1px solid;">Tgl.Jatuh Tempo</td>
                    <td style="font-size:11px;border-right:1px solid;border-bottom:1px solid;">: 
                        <?php
    ...
    <table style="width: 100%;" style="font-size:11px;" cellspacing="0" cellpadding="1">
        <tr>
            <th style="font-size:11px;border:1px solid;">No.</th>
            <th style="font-size:11px;border-top:1px solid;border-right:1px solid;border-bottom:1px solid;">Kode</th>
            <th style="font-size:11px;border-top:1px solid;border-right:1px solid;border-bottom:1px solid;">NAMA BARANG</th>
            <th style="font-size:11px;border-top:1px solid;border-right:1px solid;border-bottom:1px solid;">JMLH</th>
            <th style="font-size:11px;border-top:1px solid;border-right:1px solid;border-bottom:1px solid;">BNS</th>
            <th style="font-size:11px;border-top:1px solid;border-right:1px solid;border-bottom:1px solid;">TOTAL</th>
        </tr>
        <?php 
            $total = 0;
            $max_row=10;
        ...
        ?>
        <tr>
            <td style="font-size:11px;border-left:1px solid;border-right:1px solid;border-bottom:1px solid;"><?php echo $i + $total_product; ?>.</td>
            <td style="font-size:11px;border-right:1px solid;border-bottom:1px solid;"></td>
            <td style="font-size:11px;border-right:1px solid;border-bottom:1px solid;"></td>
            <td style="font-size:11px;border-right:1px solid;border-bottom:1px solid;"></td>
            <td style="font-size:11px;border-right:1px solid;border-bottom:1px solid;"></td>
            <td style="font-size:11px;border-right:1px solid;border-bottom:1px solid;"></td>
