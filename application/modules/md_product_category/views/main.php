<div class="row">
    ...
    <div class="col-lg-12" style="padding-bottom: 2px;">
        <a href="<?php echo site_url('master-product-category-add'); ?>" type="button" id="btn-add" class="btn btn-xs btn-success"><i class="fa fa-plus"></i> New</a>
		...
		<a href="<?php echo base_url('md_product_category/print_excel');?>" type="button" id="btn-excel" class="btn btn-xs btn-default"><i class="fa fa-edit"></i> Excel</a>
    </div>
    <div class="col-lg-12">
...
<script>
    $(document).ready(function () {
        $("#example-table").tabulator({
            ...
            ajaxURL: "<?php echo base_url('md_product_category/getListTable'); ?>", //ajax URL
            ...
            rowSelectionChanged: function (data, rows) {
                console.log(data);
                if (data.length > 0) {
                    $('#btn-edit').attr('href', '<?php echo site_url(); ?>master-product-category-edit-' + data[0]['id'] + '.html');
                    $('#btn-delete').attr('href', '<?php echo site_url(); ?>master-product-category-delete-' + data[0]['id'] + '.html');
                } else {
                    $('#btn-edit').attr('href', '#');
            ...
            rowDblClick:function(e, row){
                location.replace('<?php echo site_url(); ?>master-product-category-edit-' + row + '.html');
            },
        });
    });
