...
class Import_customer_list extends MX_Controller {
    ...
    public function getListTable() {
        ...
        $join = array(
            array('table' => 'province', 'where' => 'province.province_id=m_customer_temp.customer_province', 'join' => 'INNER'),
            array('table' => 'city', 'where' => 'city.city_id=m_customer_temp.customer_city', 'join' => 'INNER'),
            array('table' => 'district', 'where' => 'district.district_id=m_customer_temp.customer_district', 'join' => 'INNER'),
            array('table' => 'm_area', 'where' => 'm_area.id=m_customer_temp.area', 'join' => 'INNER'),
            array('table' => 'm_subarea', 'where' => 'm_subarea.id=m_customer_temp.subarea', 'join' => 'INNER'),
            array('table' => 'm_branch', 'where' => 'm_branch.id=m_customer_temp.id_branch', 'join' => 'INNER'),
        );
