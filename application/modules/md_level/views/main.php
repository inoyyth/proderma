<div class="row">
                        ...
                        <form class="form-filter-table">
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" id="search-jabatan" onkeypress="return runFilter(event)">
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="col-lg-12" style="padding-bottom: 2px;">
		...
		<a href="<?php echo base_url('md_level/print_excel');?>" type="button" id="btn-excel" class="btn btn-xs btn-default"><i class="fa fa-edit"></i> Excel</a>
    </div>
    <div class="col-lg-12">
