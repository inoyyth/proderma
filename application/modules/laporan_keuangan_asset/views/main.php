            ...
            <div class="box-body table-responsive no-padding">
                <table class="table table-hover" style="font-size: 9px;">
                    ...
                    <?php 
                       $tab_data = array(
                            "CAR",
                            "Kredit Bermasalah (Bad debt (NPL) Gross)",
                            ...
                            "Kredit/Dana Pihak Ketiga (Credit/Funding Third Parties/LDR)",
                            "Rasio Aset Produktif Terhadap Jumlah Aset (The Ratio Of Productive Assets Against Total Assets)",
                            "Rasio Laba (Rugi) Terhadap Pendapatan (The ratio of profit (loss) income)",
                            "Rasio Liabilitas Terhadap Ekuitas (The Ratio Of Liability Against Equity)",
                            "Rasio Liabilitas Terhadap Jumlah Aset (Liability Ratio Against Total Assets)"
                       );
